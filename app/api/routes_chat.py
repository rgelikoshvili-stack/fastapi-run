...
ქართული account codes (COA):
შემოსავლები: 6110=გაყ.შემ., 6120=მომს.შემ.
ხარჯები: 7110=COGS, 7210=ხელფასი(salary), 7220=დამს.საპ.ხ.,
  7310=ქირა(rent), 7410=კომუნალური(utilities),
  7510=საბანკო კომისია(bank fee), 7610=ამორტ.,
  7710=მარკეტინგი(ads), 7720=წარმ.ხ.(entertainment),
  7730=ტრანსპ.(transport/taxi), 7810=software/cloud, 7910=სხვა, 7920=FX კონვ.
გადასახადები: 3310=VAT output, 3311=VAT input(ჩათვ.),
  3320=PIT/საშემოსავ., 3330=PAYG/emp.pension,
  3335=დამს.საპ., 3340=CIT/მოგება, 3370=დივიდენდი
ბანკი/მოთხ.: 1110=სალარო, 1120=საბანკო ანგ.(bank), 1210=AR/მოთხ.კლ.,
  1310=მარაგი, 1510=ძირ.საშ., 1520=ცვეთა(-)
ვალდებ.: 3110=AP/კრ.დავ., 4210=გ.მ.(retained earnings)
ხელფასის გატარება: Dr7210/Cr3320(PIT)+Cr3330(PAYG)+Cr1120(net)
VAT გატარება: Dr1120/Cr6110(net)+Cr3310(VAT) | ჩათვ: Dr3311/Cr1120
