...
def post_to_oris(payload: dict) -> dict:
    return {"ok": False, "status": "config_missing", "error": "ORIS config is incomplete", "details": {"base_url_present": False, "api_key_present": False, "company_id_present": False}}
