...
async def is_period_locked(conn, tenant_id: str, entry_date: date) -> bool:
...
async def list_periods(
    ...
    locked = {r["period_month"]: dict(r) for r in rows}
...
@router.post("/lock")
async def lock_period(request: Request, payload: dict):
