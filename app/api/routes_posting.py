...
def get_approved_drafts(request: Request, limit: int = 100, offset: int = 0):
    _validate_pagination(limit, offset)
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return get_approved_drafts_service(limit, offset, tenant_id=tenant_id)
...
def get_posting_payload(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return get_posting_payload_service(draft_id, tenant_id=tenant_id)
...
def mock_posting(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return mock_posting_service(draft_id, tenant_id=tenant_id)
...
def get_posting_logs(
    ...
    _validate_pagination(limit, offset)
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return get_posting_logs_service(limit, offset, tenant_id, target_system, draft_id)
...
def get_posting_log_detail(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return get_posting_log_detail_service(log_id, tenant_id=tenant_id)
...
def post_draft_to_balance(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return post_draft_to_balance_service(draft_id, tenant_id=tenant_id)
...
def post_draft_to_onec(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return post_draft_to_onec_service(draft_id, tenant_id=tenant_id)
...
def post_draft_to_oris(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return post_draft_to_oris_service(draft_id, tenant_id=tenant_id)
...
def apply_posting(
    ...
    tenant_id = resolve_tenant_id(getattr(request.state, "tenant_id", None))
    return apply_posting_service(draft_id, target, tenant_id=tenant_id)