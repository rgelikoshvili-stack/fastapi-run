...
def _generate_ai_draft(extraction: dict) -> dict:
...
def _validate(entries: list) -> dict:
    errors, warnings = [], []
...
async def run_pipeline(file: UploadFile = File(...)):
    ...
    try:
        ...
        cur.execute("INSERT INTO pipeline_runs VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (
            ...
            None, None, None, None, str(e), now, now))
        conn.commit()
