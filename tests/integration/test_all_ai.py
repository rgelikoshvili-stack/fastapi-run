...
# This file is a live-API script, not a pytest test suite.
# Run directly: python tests/integration/test_all_ai.py
# pytest skips it to avoid collection-time API calls.
pytest.skip("Live AI script — run directly, not via pytest", allow_module_level=True)
