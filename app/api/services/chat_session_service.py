...
async def load_history(session_id: str, tenant_id: str) -> list[dict]:
...
async def clear_history(session_id: str, tenant_id: str) -> None:
...
async def get_session_summary(session_id: str, tenant_id: str) -> dict:
