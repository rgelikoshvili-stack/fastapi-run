...
def build_onec_payload(draft: dict) -> dict:
...
def post_to_onec(payload: dict) -> dict:
    return {"ok": False, "status": "config_missing", "error": "1C config is incomplete", "details": {"base_url_present": False, "api_key_present": False, "company_id_present": False}}
