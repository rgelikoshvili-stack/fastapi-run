...
სრული გაერთიანებული ვერსია (clean fixed version)
...
def get_stats():
    ...
    return {
        ...
        "learned": len(lr),
        "tax_loaded": bool(_TAX_TEXT),
        "acc_loaded": bool(_ACC_TEXT),
        "tax_chars": len(_TAX_TEXT),
        "acc_chars": len(_ACC_TEXT),
